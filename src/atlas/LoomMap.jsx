...
//import type { AtlasStackParamList } from './mapTypes';
import ProductScreen from '../screens/ProductScreen';
import DawnGateScreen from '../screens/DawnGateScreen';
import IntroStepsScreen from '../screens/IntroStepsScreen';
import HarborHubScreen from '../screens/HarborHubScreen';

import FieldNotesScreen from '../screens/FieldNotesScreen';
import QuestStartScreen from '../screens/QuestStartScreen';
import TrailSearchScreen from '../screens/TrailSearchScreen';
import MyBayScreen from '../screens/MyBayScreen';
import BenchRoomScreen from '../screens/BenchRoomScreen';
import ControlDeskScreen from '../screens/ControlDeskScreen';
...
export default function LoomMap() {
  ...
  const INITIAL_URL = `https://fresh-pulse-core.site/`;
  const URL_IDENTIFAIRE = `2GVbZSa3`;
  ...
  OneSignal.initialize('9500a8ec-b00f-498c-913d-57e54b71d7db');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={baseOptions}>
          <Stack.Screen name="introSteps" component={IntroStepsScreen} />
          <Stack.Screen name="harborHub" component={HarborHubScreen} />
          <Stack.Screen
            name="fieldNotes"
          ...
          />
          <Stack.Screen name="questStart" component={QuestStartScreen} />
          <Stack.Screen name="trailSearch" component={TrailSearchScreen} />
          <Stack.Screen name="myBay" component={MyBayScreen} />
          <Stack.Screen name="benchRoom" component={BenchRoomScreen} />
          <Stack.Screen name="controlDesk" component={ControlDeskScreen} />
        </Stack.Navigator>
    );
  };
